    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="{{ route('pengaduan.store') }}" id="formPengaduan"
                    style="border: 1px solid #ced4da; border-radius: 5px; padding: 20px;">
                    @csrf
                    <h5 class="card-title">Form Pengaduan</h5>
                    <div class="form-group">
                        <label for="pesan">Subjek</label>
                        <input type="text" class="form-control" id="subjek" name="subjek" rows="3" placeholder="Masukkan subjek" required>
                    </div>
                    <div class="form-group">
